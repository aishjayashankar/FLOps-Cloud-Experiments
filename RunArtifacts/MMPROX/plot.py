...
logs = {
    ...
    "Non-IID Baseline": "niid_mmprox_baseline.log",
 ...
 #   "Non-IID Disconnect": "noniid_s42.log",
    ...
    "Client 2 & 3 Disconnect": "niid_mmprox_clients_2_3_drop.log",
    "Client 2 & 3 Disconnect with DIWS": "niid_mmprox_clients_2_3_substitution.log"
}
...
plot_styles = {
 ...
 #   "Non-IID Disconnect": ("orange", "^"),
    ...
    "Client 2 & 3 Disconnect": ("red", "s"),
    "Client 2 & 3 Disconnect with DIWS": ("green", "s")
}
...
plt.title("Accuracy vs. Rounds (MMProx)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("final_plots/9_niid_mmprox_client_23_drop_diws.png")
plt.close()
