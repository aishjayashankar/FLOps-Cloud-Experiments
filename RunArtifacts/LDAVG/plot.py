...
logs = {
    ...
    "Non-IID LDAVG 100 Clients Baseline": "new_logs/ldavg_niid_100_baseline.log",
 ...
 #   "Non-IID Disconnect": "noniid_s42.log",
    ...
    "20 Clients Drop": "new_logs/ldavg_niid_100_20_drop.log",
    "20 DIWS Greedy": "new_logs/ldavg_niid_100_20_diws_greedy.log",
    ...
    # "Client 2 Disconnect with DIWS and FHE Copied Model": "new_logs/rcavg_niid_client2_drop_diws_fhe_copiedmodel.log",
...
plot_styles = {
    ...
    "Non-IID LDAVG 100 Clients Baseline": ("blue", "o"),
 ...
 #   "Non-IID Disconnect": ("orange", "^"),
    ...
    "20 Clients Drop": ("red", "s"),
    "20 DIWS Greedy": ("green", "s"),
    ...
    # "Client 2 Disconnect with DIWS and FHE Copied Model": ("purple", "s"),
...
plt.grid(True)
plt.tight_layout()
plt.savefig("new_plots/ldavg_niid_100_20_diws_greedy.png")
plt.close()
