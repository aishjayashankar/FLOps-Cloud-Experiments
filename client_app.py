...
def ShouldNodeDisconnect(partition_id, current_round):
    ...
    start_disconnect = consts.CLIENT_DROP_START_ROUND if partition_id == consts.DROPPED_CLIENT_PARTITION_ID else partition_id + 3
    end_disconnect = consts.CLIENT_DROP_END_ROUND if partition_id == consts.DROPPED_CLIENT_PARTITION_ID else 31
